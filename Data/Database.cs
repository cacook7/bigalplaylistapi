...
namespace Api.Data
{
	public class Database
	{
		...
		public Database()
		{
			string server = Environment.GetEnvironmentVariable("song_database_server");
			string name = Environment.GetEnvironmentVariable("song_database_name");
			string port = Environment.GetEnvironmentVariable("song_database_port");
			string username = Environment.GetEnvironmentVariable("song_database_username");
			string password = Environment.GetEnvironmentVariable("song_database_password");
